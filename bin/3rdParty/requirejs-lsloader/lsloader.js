...
{		
	...
	LSLoader.extend = bin.extend;

	var pro = LSLoader.prototype;

	pro.init = function(cachesJSON)
    {
    	this.URL_EXP =  /^((\w+)\:)?\/\/([^\/\\]+)/;
    ...
    pro.load = function(url, onLoad, onError)
    {
